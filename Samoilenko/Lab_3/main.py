...
# Определення класу Product та його підкласів
class Product:
...
# Определення класу Container та його підкласів
class Container:
...
def create_containers(data):
    ...
    for port_data in data:
        ...
        for _ in range(basic_count):
            containers.append(BasicContainer(UUID()))

        for _ in range(heavy_count):
            containers.append(HeavyContainer(UUID()))

        for _ in range(refrigerated_count):
            containers.append(RefrigeratedContainer(UUID()))

        for _ in range(liquid_count):
            containers.append(LiquidContainer(UUID()))
